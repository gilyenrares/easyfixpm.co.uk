	...
	<form action="includes/contact.inc.php" method="post">
  		<div class="form row">
    		...
    		<div class="form-group col-md-9">
      			...
      			<input type="text" class="form-control" name="ln" id="name" placeholder="Name" value="<?php if (isset($_GET['ln'])) {echo $_GET['ln'];} ?>" required="required">
    		</div>
  		</div>
        ...
        <textarea  class="form-control" name="description" id="description" rows="6" value="<?php if (isset($_GET['description'])) {echo $_GET['description'];} ?>" required="required"></textarea>
  		...
  		<div class="form-group col-md-4" >
    		<div class="form-check">
      			<input class="form-check-input ms-4" name="agree" type="checkbox" id="check" required="required">
      ...
      <div class="btn-group btn-group-lg d-flex mt-2" role="group" aria-label="Basic example">
        <button type="submit" class="btn btn-success border-secondary mr-2 rounded text-white" name="quote-submit" >Request quote</button>
